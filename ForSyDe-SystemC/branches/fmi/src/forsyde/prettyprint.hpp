/**********************************************************************           
    * prettyprint.hpp -- Pretty-printing STL containers               *
    *                                                                 *
    * Author:  louisdx (http://louisdx.github.com/cxx-prettyprint/)   *
    *                                                                 *
    * Purpose: Making the communication of STL objects, particularly, *
    *          vectors and tuples possible                            *
